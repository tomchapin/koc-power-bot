  ...
  init : function (div){
    ...
    try {      
      m = '<DIV style="height:500px; max-height:500px; overflow-y:auto"><TABLE width=100% class=pbOptions cellspacing=0 cellpadding=0>\
		...
		<tr><td>&nbsp;&nbsp;&nbsp-</td><td>Save Range items: '+ htmlSelector({0:'----', 1:'All Range', 3:'Either top 1 or 2 slot', 5:'Only Best', 8:'Top 2 both range'},Options.RangeSaveModeSetting,'id=selectRangeSaveMode') + '<span style="color:#800; font-weight:bold"><sup> &nbsp *Saves range items</sup></span></td></tr>\
